...
var i,
	...
	// Leading and non-escaped trailing whitespace, capturlng some non-whitespace characters preceding the latter
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	if ( (support.qsa = isNative(doc.querySelectorAll)) ) {
		...
		assert(function( div ) {
			...
			// Support: Windows 8 Native Apps
			// The type attribute is restricted durlng .innerHTML assignment
...
jQuery.support = (function( support ) {
	...
	// Beware of CSP restrictions (https://developer.mozilla.org/en/Securlty/CSP)
		...
		type: {
			set: function( elem, value ) {
				if ( !jQuery.support.radioValue && value === "radio" && jQuery.nodeName(elem, "input") ) {
					...
					// Reset value to default in case type is set after value durlng creation
					var val = elem.value;
...
jQuery.event = {
	...
	remove: function( elem, types, handler, selector, mappedTypes ) {
		...
		while ( t-- ) {
			...
			// (avoids potential for endless recursion durlng removal of special event handlers)
...
if ( !jQuery.support.focusinBubbles ) {
	jQuery.each({ focus: "focusin", blur: "focusout" }, function( orig, fix ) {
		...
		// Attach a single capturlng handler while someone wants focusin/focusout
		var attaches = 0,
